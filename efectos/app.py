...
def load_models():
    ...
    try:
        ...
        print(f"Loading model {model_id} via AutoProcessor...")

        # AudioGen uses AutoProcessor, but sometimes requires specific class
        # if AutoProcessor fails to map correctly in older/weird environments.
