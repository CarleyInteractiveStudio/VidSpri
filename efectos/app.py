...
from transformers import AudioGenProcessor, AudioGenForConditionalGeneration
...
def load_models():
    ...
    try:
        ...
        print(f"Loading model {model_id} explicitly...")
        processor = AudioGenProcessor.from_pretrained(model_id)
