...
async def verify_layout():
    async with async_playwright() as p:
        ...
        await page.screenshot(path="verification/extraer_layout_v3.png")
        ...
        await page.screenshot(path="verification/previsualizacion_load_v3.png")

        has_download_btn = await page.evaluate("""() => {
            // Check for the link as we used an <a> tag
            return !!document.getElementById('download-sprite-link');
        }""")
        print(f"Has download link/button: {has_download_btn}")
